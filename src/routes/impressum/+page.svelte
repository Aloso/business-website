...
<Block>
  ...
  <p>
    ...
    Ihre Privatsphäre zu würdigen. Bei inhaltlichen oder technischen Fragen schreiben Sie bitte eine
    E-Mail an
    <a href="mailto:kontakt@ludwigstecher.de">kontakt@ludwigstecher.de</a>.
  </p>
